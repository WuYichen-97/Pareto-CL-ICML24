...
def get_parser() -> ArgumentParser:
    ...
    # tinyimg 0.1,0.07,0.999,0.08,0.999
    # Consistency Regularization Weight
    parser.add_argument('--reg_weight', type=float, default= 0.15 )   #1  0.15

    # Stable Model parameters
    parser.add_argument('--stable_model_update_freq', type=float, default=0.8) #0.9 0.1
    parser.add_argument('--stable_model_alpha', type=float, default=0.99)

    # Plastic Model Parameters
    parser.add_argument('--plastic_model_update_freq', type=float, default=0.9) #0.9 0.3
    parser.add_argument('--plastic_model_alpha', type=float, default=0.99)
