...
class ErACE(ContinualModel):
    ...
    def observe(self, inputs, labels, not_aug_inputs,t):
        ...
        # logits = self.net(inputs, mode='surrogate')
        ...
        #     buf_inputs = torch.cat((inputs,buf_inputs))
        #     buf_labels = torch.cat((labels,buf_labels))    
    ...
    def observe_test(self, inputs, labels, t):
