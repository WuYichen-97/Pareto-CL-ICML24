...
class SequentialCIFAR10(ContinualDataset):
    ...
    def get_data_loaders(self, tag=False):
        ...
        # train_dataset = My_Noise_CIFAR10(seed=1, dataset='cifar10', imbalanced_factor=None,Reverse=False, corruption_type=None, corruption_ratio=0.2)
        # train_dataset = My_Noise_CIFAR10(seed=1, dataset='cifar10', imbalanced_factor=None,Reverse=False, corruption_type='uniform', corruption_ratio=0.4)
    ...
    #                 * SequentialCIFAR10.N_TASKS)
        ...
        # model = resnet18(SequentialCIFAR10.N_CLASSES_PER_TASK
        #                 * SequentialCIFAR10.N_TASKS)
